...
# Shared: Fonts
HACK_NERD_PREFIX="https://github.com/ryanoasis/nerd-fonts/raw/v3.1.1/patched-fonts/Hack"
CHIRON_HEI_PREFIX="https://github.com/chiron-fonts/chiron-hei-hk/raw/v2.509/TTF"
CHIRON_SUNG_PREFIX="https://github.com/chiron-fonts/chiron-sung-hk/raw/v1.011/TTF"
DOWNLOAD_FONTS=(
  "https://github.com/googlefonts/noto-emoji/raw/v2.038/fonts/NotoColorEmoji.ttf"
  "${HACK_NERD_PREFIX}/Bold/HackNerdFont-Bold.ttf"
  "${HACK_NERD_PREFIX}/BoldItalic/HackNerdFont-BoldItalic.ttf"
  "${HACK_NERD_PREFIX}/Italic/HackNerdFont-Italic.ttf"
  "${HACK_NERD_PREFIX}/Regular/HackNerdFont-Regular.ttf"
